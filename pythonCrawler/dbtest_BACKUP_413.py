...
<<<<<<< HEAD
        con = db.connect('DRIVER={ODBC Driver 17 for SQL Server};SERVER=mydb.cegjysnrs662.ap-southeast-2.rds.amazonaws.com;DATABASE=iBookStore.Services.CatalogDb;UID=sa; PWD=testtest')
=======
        con = ''
>>>>>>> 14ba0b015c49eb028a49480d6e8a2b251fadb266
        cur = con.cursor()
